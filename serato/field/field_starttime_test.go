...
func TestNewStartTimeField(t *testing.T) {
	...
	if err != nil {
		t.Fatal("expected NewStartTimeField err to be nil")
	}
...
func TestNewStartTimeFieldUnexpectedEOF(t *testing.T) {
	...
	if err != io.ErrUnexpectedEOF {
		t.Fatal("expected NewStartTimeField err to be ErrUnexpectedEOF")
	}
}
...
func TestNewStartTimeFieldUnexpectedIdentifier(t *testing.T) {
	...
	if err != field.ErrUnexpectedIdentifier {
		t.Fatal("expected NewStartTimeField err to be ErrUnexpectedIdentifier")
	}
}
