...
func TestNewField72Field(t *testing.T) {
	...
	if err != nil {
		t.Fatal("expected NewField72Field err to be nil")
	}
...
func TestNewField72FieldUnexpectedEOF(t *testing.T) {
	...
	if err != io.ErrUnexpectedEOF {
		t.Fatal("expected NewField72Field err to be ErrUnexpectedEOF")
	}
}
...
func TestNewField72FieldUnexpectedIdentifier(t *testing.T) {
	...
	if err != field.ErrUnexpectedIdentifier {
		t.Fatal("expected NewField72Field err to be ErrUnexpectedIdentifier")
	}
}
